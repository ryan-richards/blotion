          ...
          >
            ...
            >
              ...
              <HStack mt={{ base: 5, md: 8 }} spacing={{ base: 5, md: 20 }}>
                <Tooltip
                  label={"Copy the Blotion Template"}
                  hasArrow
                  placement="top"
                >
                  <IconButton
              ...
              <Flex mt={10} direction={"column"} gap={8}>
                ...
                <Heading
                  ...
                  fontWeight={"medium"}
                >
                  You site will be hosted on{" "}
                  <Text fontWeight={"bold"}>yoursubdomain.blotion.com</Text>
                </Heading>
              </Flex>
            </Flex>
            ...
            >
              ...
              <Heading fontSize={"lg"} fontWeight={"normal"}>
                All the boring stuff is taken care of so you can focus on
                writing.
              </Heading>
                ...
                <Stack width={"50%"} spacing={5}>
                  {features.map((feature) => (
                    <Heading
                      key={feature.id}
                      cursor={"pointer"}
                      opacity={activeFeature.id === feature.id ? "100%" : "55%"}
            ...
            >
              ...
              >
                ...
                <Text fontSize={"xl"}>Creative + Pro Accounts Unlock</Text>
              </Flex>
              <Grid
              ...
              <Flex
                ...
                justify={"center"}
              >
                <Button size={"lg"} onClick={() => nav("/pricing")} mt={5}>
                  View Pricing
                </Button>
              </Flex>
            </Flex>
            ...
            >
              <Heading textAlign={"center"}>
                I think you're ready to start a blog.
              </Heading>
              <Text textAlign={"center"} fontSize={"xl"}>
                Start by duplicating the template below into your Notion
                Workspace!
              </Text>
              <Button
                mt={2}
